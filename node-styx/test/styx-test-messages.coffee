...
module.exports = [
    {
        ...
        decoded: {type: 'Tversion', tag: 65535, messageSize: 8192, protocol: '9P2000'}
    },
    {
        encoded: new Buffer "1c0000006601002a00000005006b616262690800617574686e616d65", "hex"
        decoded: {type: 'Tauth', tag: 1, authFid: 42, userName: 'kabbi', authName: 'authname'}
    },
    {
        encoded: new Buffer "090000006c01006400", "hex"
        decoded: {type: 'Tflush', tag: 1, oldTag: 100}
    },
    {
        encoded: new Buffer "1f0000006801000a0000001400000004007a7562720800617574686e616d65", "hex"
        decoded: {type: 'Tattach', tag: 1, fid: 10, authFid: 20, userName: 'zubr', authName: 'authname'}
    },
    {
        ...
        decoded: {type: 'Twalk', tag: 1, fid: 100, newFid: 200, pathEntries: ['some', 'long', 'path', 'here', 'follows']}
    },
    {
        encoded: new Buffer "0c0000007001000a00000014", "hex"
        decoded: {type: 'Topen', tag: 1, fid: 10, mode: 20}
    },
    {
        encoded: new Buffer "1a000000720100f20000000800736f6d654e616d65020000000a", "hex"
        decoded: {type: 'Tcreate', tag: 1, fid: 242, name: 'someName', perm: 2, mode: 10}
    },
    {
        encoded: new Buffer "170000007401000a0000001027000000000000204e0000", "hex"
        decoded: {type: 'Tread', tag: 1, fid: 10, offset: 10000, count: 20000}
    },
    {
        encoded: new Buffer "0b000000780100e7030000", "hex"
        decoded: {type: 'Tclunk', tag: 1, fid: 999}
    },
    {
        encoded: new Buffer "0b0000007a0100de000000", "hex"
        decoded: {type: 'Tremove', tag: 1, fid: 222}
    },
    {
        encoded: new Buffer "0b0000007c010003000000", "hex"
        decoded: {type: 'Tstat', tag: 1, fid: 3}
    },
    # {
